...
#Commented out because it keeps complaining "Error creating Firewall: googleapi: Error 400: Invalid value for field 'resource.targetTags[0]': '"tf-lb-https-gke"'. Must be a match of regex '(?:[a-z](?:[-a-z0-9]{0,61}[a-z0-9])?)"
